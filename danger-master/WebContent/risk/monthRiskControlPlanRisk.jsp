						...
						<div class=" col-md-12">
							...
							<div class="panel panel-default el_Mainmain" style="margin-top: 0px;">
								...
								<div class="panel-body">
									...
									<div>
									<h4>月风险管控计划风险</h4>
									<button id="conpyPrecedingMonthButton" class="btn btn-primary" onclick="conpyPrecedingMonth()">复制上月风险管控计划风险数据</button>
									...
									<button type="button" class="btn btn-primary" onclick="extEmpTrain()">导出该月管控计划下的风险信息</button>
