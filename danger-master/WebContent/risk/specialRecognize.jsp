...
<script type="text/javascript" src="<%=path%>/js/risk/speciaRecognize.js"></script>
<!-- 用于表单校验的 -->
...
<body>
	...
	<form id="detailForm" action="${pageContext.request.contextPath }/identify_detailOpS.action" method="post">
		<!-- 隐藏要提交的数据 -->
						...
						<div class=" col-md-12">
							...
							<div class="panel panel-default el_Mainmain">
								...
								<div class="panel-body">
									...
									<div>
									<button  class="btn btn-primary" data-toggle="modal" data-target="#addDuty" onClick="$.Pop('每个专项只能有一条专项辨识信息，可以通过“详情”维护专项风险辨识信息。','confirm',function(){}),addOpenBtn()" >新增</button>
									</div>
